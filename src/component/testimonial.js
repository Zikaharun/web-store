...
<section className="bg-slate-300">
  <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <div className="md:flex-row md:items-end items-center flex flex-col md:justify-between">
      ...
      <a
        href="#"
        className="mt-6 inline-flex shrink-0 items-center gap-2 rounded-full border border-black px-5 py-3 text-black transition hover:bg-slate-500 hover:text-white md:mt-0"
      >
    ...
    <div className="mt-8 grid grid-cols-1  gap-4 md:grid-cols-3">
      <blockquote className="flex h-full flex-col justify-between bg-white p-6 rounded-lg shadow-lg">
        <div>
